 ...
 *                                 spread out after the exaggeration phase. This
 *                                 is typically 1 for Barnes-Hut and >1 for FFT.
...
void TSNE_fit(
  ...
  int verbosity = CUML_LEVEL_INFO, const bool intialize_embeddings = true,
  TSNE_ALGORITHM algorithm = TSNE_ALGORITHM::FFT, ProgressCb prog = nullptr);
